...
> [Documentation](https://github.com/BRama10/easyai4all/blob/main/README.md).

Before you ask a question, it is best to search for existing [Issues](https://github.com/BRama10/easyai4all/issues)
that might help you. If you find a relevant issue that already exists and still need clarification, please add your question to that existing issue.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/BRama10/easyai4all/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment 
  components/versions (Make sure that you have read the [documentation](https://github.com/BRama10/easyai4all/blob/main/README.md).
  If you are looking for support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having,
  check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/BRama10/easyai4all?q=label%3Abug).
...
> the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to <balajirw10@gmail.com>.
<!-- You may add a PGP key to allow the messages to be sent encrypted as well. -->

We use GitHub issues to track bugs and errors. If you run into an issue with the project:

- Open an [Issue](https://github.com/BRama10/easyai4all/issues/new). (Since we can't be sure at
...
This section guides you through submitting an enhancement suggestion for easyai4all,
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/BRama10/easyai4all/blob/main/README.md) carefully
  and find out if the functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/BRama10/easyai4all/issues) to see if the enhancement has
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/BRama10/easyai4all/issues).

- Use a **clear and descriptive title** for the issue to identify the suggestion.
- Provide a **step-by-step description of the suggested enhancement** in as many details as possible.
- **Describe the current behavior** and **explain which behavior you expected to see instead** and why.
  At this point you can also tell which alternatives do not work for you.
- **Explain why this enhancement would be useful** to most easyai4all users. You may also want to
...
the `easyai4all` repository and then clone your forked repository:

```bash
git clone https://github.com/<YOUR_GITHUB_USER>/easyai4all.git
```
...
`easyai4all` uses pre-commit to ensure the formatting is consistent:
```bash
pre-commit install
```
...
#### Testing
`easyai4all` tracks unit tests. Pytest is used to execute said unit tests in `tests/`:

```bash
# for mock tests
pytest tests/mock -vv --verbose

# for integration tests (ensure all necessary API keys are setup in the environment)
